                    ...
                    <tbody>
                        {assignmentData.data.length === 0 ? (
                            ...
                            assignmentData.data.map((assignment, index) => (
                                <tr key={assignment.empid + assignment.projid} className={`text-center ${index % 2 === 0 ? 'bg-white' : 'bg-gray-100'} hover:bg-gray-50`}>
                                    <td className="border p-2">{assignment.empid}</td>
                                    <td className="border p-2">{assignment.projid}</td>
