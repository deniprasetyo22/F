...
const AddLeaveRequestPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        if (leaveRequest.leaveType === 'Sick Leave' && totalDays > 3 && !file) {
            errorMessage.sickLeave = 'Sick leave more than 3 days must have a medical certificate.';
        }
        ...
        <div className="max-w-3xl mx-auto bg-white p-8 rounded-lg shadow-lg my-8">
            ...
            <form className="space-y-6" onSubmit={handleSubmit}>
                ...
                <div>
                    ...
                    {error.sickLeave && <span className="text-sm text-red-500">{error.sickLeave}</span>}
                </div>
