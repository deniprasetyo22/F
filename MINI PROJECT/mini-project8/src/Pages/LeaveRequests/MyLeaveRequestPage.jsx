    ...
    <div className="p-6">
      ...
      <div className="overflow-x-auto">
        <table className="w-full border-collapse border rounded-md overflow-hidden">
          <thead>
            <tr className="bg-gray-600 text-white text-uppercase leading-normal">
              <th className="border py-3 px-6">No</th>
              ...
              userLeaveRequests.map((leaveRequest, index) => {
                return (
                  <tr key={leaveRequest.requestid} className={`text-center ${index % 2 === 0 ? 'bg-white' : 'bg-gray-100'}`}>
                    ...
                    <td className="border py-3 px-6">{new Date(leaveRequest.process.requestdate).toLocaleString()}</td>
                    <td className="border py-3 px-6">
