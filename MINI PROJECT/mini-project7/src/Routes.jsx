...
import LeaveRequestPages from './Pages/LeaveRequests/LeaveRequestPages';
import MyLeaveRequestPage from './Pages/LeaveRequests/MyLeaveRequestPage';
import AddLeaveRequestPage from './Pages/LeaveRequests/AddLeaveRequestPage';
import MyLeaveRequestDetailPage from './Pages/LeaveRequests/MyLeaveRequestDetailPage';
import LeaveRequestReviewPage from './Pages/LeaveRequests/LeaveRequestReviewPage';
...
const Routes = createBrowserRouter([
    ...
    },
    {
        ...
        element: <PrivateRoute allowedRoles={['Administrator', 'Employee Supervisor']} />,
        children: [
            {
                path: '/employees/:empid',
                element: <DetailEmployeePage />
    ...
    },
    {
        ...
        children: [
            {
                path: '/leaverequests',
                element: <LeaveRequestPages />
            },
            {
                path: '/leaverequest/:requestid',
                element: <LeaveRequestReviewPage />
            },
            {
                path: '/myleaverequests',
                element: <MyLeaveRequestPage />
            },
            {
                path: '/myleaverequest/:requestid',
                element: <MyLeaveRequestDetailPage />
            },
            {
                path: '/myleaverequest/new',
