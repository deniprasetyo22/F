...
const BookDetailPage = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        setLoading(true);
        try {
            await BookService.update(bookId, updatedBook);
            const response = await BookService.get(bookId);
            setBook(response.data);
            ...
            const errorMessage = error.response ? error.response.message : 'An error occurred while updating the book details. Please try again later.';
            Swal.fire({
                title: 'Error!',
                text: errorMessage,
                icon: 'error',
